...
public class OtherPaymentBeanValidator implements Validator {

	@Override
	public boolean supports(Class<?> arg0) {
		return OtherPaymentBean.class.isAssignableFrom(arg0);
	}

	@Override
	public void validate(Object arg0, Errors errors) {/*
		OtherPaymentBean otherPaymentBean = (OtherPaymentBean) arg0;
		String mandatoryFields[] = { "otherPaymentName", "companyName",
				"companyMobile1" };
