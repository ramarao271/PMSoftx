...
public class ProductionInvoiceBeanValidator implements Validator {

	@Override
	public boolean supports(Class<?> arg0) {
		return ProductionInvoiceBean.class.isAssignableFrom(arg0);
	}

	@Override
	public void validate(Object arg0, Errors errors) {/*
		ProductionInvoiceBean productionInvoiceBean = (ProductionInvoiceBean) arg0;
		String mandatoryFields[] = { "productionInvoiceName", "companyName",
				"companyMobile1" };
