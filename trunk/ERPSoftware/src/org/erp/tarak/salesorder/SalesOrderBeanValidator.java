...
public class SalesOrderBeanValidator implements Validator {

	@Override
	public boolean supports(Class<?> arg0) {
		return SalesOrderBean.class.isAssignableFrom(arg0);
	}

	@Override
	public void validate(Object arg0, Errors errors) {/*
		SalesOrderBean salesOrderBean = (SalesOrderBean) arg0;
		String mandatoryFields[] = { "salesOrderName", "companyName",
				"companyMobile1" };
