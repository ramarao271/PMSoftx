					...
					<table>
						<thead>
							<tr>
								...
								<th><div label="Opening Balance"></div></th>
								<th><div label="Current Transactions"></div></th>
						...
						<tbody>
							<c:forEach items="${customers}" var="customer">
								<tr>
									...
									<td><c:out value="${customer.openingBalance}" /></td>
									<td><c:out value="${customer.currentBalance}" /></td>
									<td><c:out value="${customer.currentBalance-customer.openingBalance}" /></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
