	...
	<c:if test="${!empty products}">
		<table align="left" border="1" cellpadding="2px" cellspacing="0">
			...
			<c:forEach items="${products}" var="product">
				<tr>
					<td><c:if test="${! empty product.variantBeans }"><a href="#" data-showpopup="${product.productId}"><img class="arrowRotate" data-swap="${variantImg}"
					...
					<td align="center"><a
						href="editProduct.html?productId=${product.productId}"><img src="${editImg}" /></a> |
						<a href="deleteProduct.html?productId=${product.productId}"
