		...
		<table align="left" border="1" cellpadding="0" cellspacing="0">
			...
			<c:forEach items="${salesPayments}" var="salesPayment">
				<tr>
					...
					<td align="center"><a
						href="editSalesPayment.html?salesPaymentId=${salesPayment.salesPaymentId}"><img src="${editImg}" /></a>
						| <a
						href="deleteSalesPayment.html?salesPaymentId=${salesPayment.salesPaymentId}"
